...
const Icons = {
    ...
    navBancos: () => `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" style="flex-shrink:0" aria-hidden="true"><rect x="3" y="19" width="18" height="2" rx="1" fill="#3b82f6"/><path d="M12 3L2 9h20L12 3z" fill="#3b82f6" opacity="0.2"/><path d="M12 3L2 9h20L12 3z" stroke="#3b82f6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" fill="none"/><rect x="5" y="11" width="3" height="6" rx="1" fill="#14b8a6"/><rect x="10.5" y="11" width="3" height="6" rx="1" fill="#8b5cf6"/><rect x="16" y="11" width="3" height="6" rx="1" fill="#f97316"/></svg>`,
    ...
    arrowRight: (size=16) => `<svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M5 12h14M12 5l7 7-7 7" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
    ...
    docList: (size=16) => `<svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2" fill="#8b5cf6" opacity="0.1"/><path d="M8 7h8M8 12h8M8 17h5" stroke="#8b5cf6" stroke-width="2" stroke-linecap="round"/></svg>`,
    
    bankJardinAzuayo: (size=24) => `<svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none"><rect width="24" height="24" rx="6" fill="#00833E"/><path d="M12 5l7 7-2 2-5-5-5 5-2-2 7-7z" fill="#FFF"/><path d="M12 11l5 5-2 2-3-3-3 3-2-2 5-5z" fill="#FFF"/></svg>`,
    ...
    trendingUp: (size=16) => `<svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M23 6l-9.5 9.5-5-5L1 18" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/><polyline points="17 6 23 6 23 12" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
    trendingDown: (size=16) => `<svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M23 18l-9.5-9.5-5 5L1 6" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/><polyline points="17 18 23 18 23 12" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
    wallet: (size=16) => `<svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M20 12V8H6a2 2 0 0 1-2-2c0-1.1.9-2 2-2h12v4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M4 6v12c0 1.1.9 2 2 2h14v-4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M18 12a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2h4v-6h-4z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>`
};
